...
int customerId;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("EDITAR CADASTRO DE CLIENTES");
...
this.dispose();
 ...
 try {
    ...
    String doc = documentField.getText().replaceAll("[^0-9]", "").trim(); // remove caracteres não numéricos
    String address = addressField.getText().trim();
    String number = numberField.getText().replaceAll("[^0-9]", "").trim(); // remove caracteres não numéricos
    ...
    if (!(doc.matches("\\d{11}") || doc.matches("\\d{14}"))) {
        JOptionPane.showMessageDialog(this, "Documento inválido! Informe um CPF (11 dígitos) ou CNPJ (14 dígitos).");
        return;
    }
    ...
    JOptionPane.showMessageDialog(this, "Ocorreu um erro ao atualizar o cliente: " + e.getMessage());
}
