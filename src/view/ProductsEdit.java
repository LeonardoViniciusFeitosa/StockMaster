...
public class ProductsEdit extends javax.swing.JFrame {
   ...
   private int productId;
    ...
    private void FieldsUpdate(int id){
        Product p = TempDatabase.getProductById(id);
    ...
    try {
        ...
        BigDecimal costValue = new BigDecimal(costField.getText());
        BigDecimal sellValue = new BigDecimal(sellField.getText());
        String obs = NotesArea.getText();
        ...
        if (name == null || name.trim().isEmpty()
            ...
            || sellValue.compareTo(BigDecimal.ZERO) <= 0) {

            JOptionPane.showMessageDialog(rootPane, "Preencha todos os campos corretamente!");
            return;
        }

        Product product = TempDatabase.getProductById(productId);
    ...
    JOptionPane.showMessageDialog(this, "Ocorreu um erro ao atualizar o produto: " + e.getMessage());
}
