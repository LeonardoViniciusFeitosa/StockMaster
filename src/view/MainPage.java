...
public class MainPage extends javax.swing.JFrame {
  ...
  User active = TempDatabase.getActiveUser();
if (active != null) {
    ...
    for (StockEntry e : TempDatabase.getEntries()){
    Object[] row = {
        e.getId(),
        e.getProductName(),
        e.getSupplierName(),
    ...
    for (StockOut o : TempDatabase.getOuts()){
    Object[] row = {
        o.getId(),
        o.getProductName(),
        o.getQuantity(),
    ...
    for (Sale s : TempDatabase.getSales()){
    Object[] row = {
        s.getId(),
        s.getProduct(),
        s.getCustomer(),
