 ...
 * @author leona
 */
public class EntryRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lSupplier1 = new javax.swing.JButton();
        ...
        lSupplier1.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        lSupplier1.setText("Lista de Fornecedores");
        lSupplier1.setBorderPainted(false);
        lSupplier1.setContentAreaFilled(false);
        lSupplier1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lSupplier1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lSupplier1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lSupplier1ActionPerformed(evt);
            }
        });
        panelGradiente1.add(lSupplier1);
        lSupplier1.setBounds(10, 280, 200, 20);

        jLabel12.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 0, 255));
        jLabel12.setText("- Registro de Entrada de Estoque");
        panelGradiente1.add(jLabel12);
        jLabel12.setBounds(20, 500, 220, 18);
...
this.dispose();
    ...
    try {
        ...
        if (quantity <= 0) {
            JOptionPane.showMessageDialog(rootPane, "Escolha um número maior que 0.");
            return;
        }
    ...
    if (!p.increaseQuantity(quantity)) {
        JOptionPane.showMessageDialog(rootPane, "Não foi possível atualizar o estoque.");
        return;
    }
...
this.dispose();
    ...
    private void lSupplier1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lSupplier1ActionPerformed
SupplierList lSupplier = new SupplierList();
lSupplier.setVisible(true);
this.dispose();
    }//GEN-LAST:event_lSupplier1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntryRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntryRegister().setVisible(true);
            }
        });
    }
