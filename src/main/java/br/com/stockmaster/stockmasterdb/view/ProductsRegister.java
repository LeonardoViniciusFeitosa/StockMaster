 ...
 * @author leona
 */
public class ProductsRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        InitialQuantityField = new javax.swing.JTextField();
        ...
        InitialQuantityField.setBackground(new java.awt.Color(204, 204, 204));
        InitialQuantityField.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        InitialQuantityField.setForeground(new java.awt.Color(0, 0, 0));
        InitialQuantityField.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 1));
        ...
        obsArea.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(InitialQuantityField, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel11)
                    .addComponent(InitialQuantityField, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel12)
                    .addComponent(jLabel13)
...
try {
    ...
    String initialQuantityRaw = InitialQuantityField.getText().trim();
    ...
    if (initialQuantityRaw.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo QUANTIDADE está vazio!");
        return;
    }
    if (costRaw.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo VALOR DE CUSTO está vazio!");
        return;
    }
    if (sellRaw.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo VALOR DE VENDA está vazio!");
        return;
    }
    ...
    try {
        initialQuantity = Integer.parseInt(initialQuantityRaw);
        if (initialQuantity < 0) {
            JOptionPane.showMessageDialog(this, "A QUANTIDADE INICIAL não pode ser negativa!");
            return;
        }
...
p.setQuantity(initialQuantity);
p.setCostValue(costValue);
p.setSellValue(sellValue);
p.setNotes(obs);
...
comboBoxUpdate();
    ...
    JOptionPane.showMessageDialog(this, "Ocorreu um erro ao salvar o produto. Verifique os dados e tente novamente.");
}

} catch (Exception e) {
    JOptionPane.showMessageDialog(this, "Ocorreu um erro ao registrar o produto: " + e.getMessage());
}
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductsRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductsRegister().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField InitialQuantityField;
