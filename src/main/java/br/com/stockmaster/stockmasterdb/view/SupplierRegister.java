...
this.dispose();
    ...
    String cnpjRaw = cnpjField.getText().trim();
    String address = addressField.getText().trim();
    String numberRaw = numberField.getText().trim();
    ...
    if (cnpjRaw.isEmpty()) {
        JOptionPane.showMessageDialog(this, "O campo CNPJ está vazio!");
        return;
    }
    if (address.isEmpty()) {
    ...
    String cnpj = cnpjRaw.replaceAll("[^0-9]", "");
    String number = numberRaw.replaceAll("[^0-9]", "");
    ...
    JOptionPane.showMessageDialog(this, "Ocorreu um erro ao cadastrar o fornecedor. Reescreva e tente novamente.");
    }   
